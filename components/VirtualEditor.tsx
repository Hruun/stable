...
import { VirtualTranscriptView, VirtualTranscriptViewHandle } from './VirtualTranscriptView';
        ...
        return (
            <div className="flex-1 flex flex-col items-center justify-center bg-gray-800/50 p-8">
                 <div className="text-center p-12 border-2 border-dashed border-gray-600 rounded-xl">
                    ...
                    <p className="mt-1 text-sm text-brand-blue">⚡ Virtual Editor - Optimized for Performance</p>
                    <div className="mt-6">
